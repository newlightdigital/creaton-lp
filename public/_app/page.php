...
<!-- Floating WhatsApp (desktop). The rebuild dropped the site's WhatsApp button, which
     was the top lead channel on the old site (~5-6 clicks/day). On phones WhatsApp lives
     in the sticky bottom bar instead. The wa.me click fires the GTM "Click WhatsApp" tag. -->
<a class="wa-fab" href="https://wa.me/<?= ltrim(CREATON_PHONE_E164, '+') ?>?text=<?= rawurlencode('Bună ziua! Aș dori o ofertă pentru lucrări la acoperiș.') ?>" target="_blank" rel="noopener" aria-label="Scrieți-ne pe WhatsApp">
  ...
  <span class="wa-txt">Scrieți pe WhatsApp</span>
</a>
...
<!-- ===================== STICKY MOBILE BAR ===================== -->
<div class="mobilebar">
  <a class="btn btn-wa" href="https://wa.me/<?= ltrim(CREATON_PHONE_E164, '+') ?>?text=<?= rawurlencode('Bună ziua! Aș dori o ofertă pentru lucrări la acoperiș.') ?>" target="_blank" rel="noopener" aria-label="Scrieți-ne pe WhatsApp">
  ...
  <a class="btn btn-amber" href="#oferta">Ofertă</a>
</div>
